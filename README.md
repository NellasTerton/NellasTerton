...
Я соединяю художественное письмо и техническую логику. Я проектирую процедурные нарративы, создаю сложных AI-персонажей (ToV) и строю игровые циклы на основе LLM. От идеи до продакшена — фронтенд, база, интеграции, деплой.
